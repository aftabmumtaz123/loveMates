...
export default function Dashboard(){
  ...
  return <div className="space-y-7">
    ...
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4"><Link to="/rituals" className="stat-card"><span className="icon-square tone-1"><Heart size={17}/></span><span><span className="block text-xs font-semibold text-slate-400">Daily rituals</span><span className="mt-1 block text-sm font-bold">Q&A · Mood · Love Jar</span></span></Link><Link to="/letters" className="stat-card"><span className="icon-square tone-2"><Gift size={17}/></span><span><span className="block text-xs font-semibold text-slate-400">Open When</span><span className="mt-1 block text-sm font-bold">Letters for later</span></span></Link><Link to="/timeline" className="stat-card"><span className="icon-square tone-3"><CalendarDays size={17}/></span><span><span className="block text-xs font-semibold text-slate-400">Our story</span><span className="mt-1 block text-sm font-bold">Timeline</span></span></Link><Link to="/stats" className="stat-card"><span className="icon-square tone-0"><Sparkles size={17}/></span><span><span className="block text-xs font-semibold text-slate-400">Our stats</span><span className="mt-1 block text-sm font-bold">See your year</span></span></Link></div>{error&&<div className="alert-error">{error}</div>}
